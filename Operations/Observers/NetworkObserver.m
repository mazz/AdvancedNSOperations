...
- (void)operationDidStart:(KADOperation * __nonnull)operation
{
...
- (void)operation:(KADOperation * __nonnull)operation didProduceOperation:(NSOperation * __nonnull)newOperation
{
}

- (void)operationDidFinish:(KADOperation * __nonnull)operation errors:(NSArray * __nonnull)errors
{
    dispatch_async(dispatch_get_main_queue(), ^{
